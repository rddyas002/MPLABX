...
#define IO_HEARTBEAT_TRIS()         PORTSetPinsDigitalOut(IOPORT_E, BIT_3)
#define IO_TOGGLE_HEARTBEAT()       PORTToggleBits(IOPORT_E, BIT_3)
#define IO_SET_HEARTBEAT()          PORTSetBits(IOPORT_E, BIT_3)
#define IO_CLEAR_HEARTBEAT()        PORTClearBits(IOPORT_E, BIT_3)
...
#define IO_USER_TRIS()             PORTSetPinsDigitalIn(IOPORT_E, BIT_6)
...
IO_EXTERN bool ADC_updated(void);
IO_EXTERN void ADC_update_clear(void);
IO_EXTERN char IO_getChecksum(char * buffer, char length);
IO_EXTERN float IO_temperature_control(float temperature_reference, float measured_temperature, float lower_ctrl_limit, float upper_ctrl_limit, float dt, bool initialise,
